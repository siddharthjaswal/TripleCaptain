                ...
                <div
                  ...
                  className={`flex-1 rounded-lg px-2 py-2 text-center border-2 ${
                    fixture.difficulty <= 2
                      ? "bg-green-50 border-green-600 text-green-950 dark:bg-green-500/20 dark:border-green-500/40 dark:text-green-300"
                      : fixture.difficulty === 3
                        ? "bg-amber-50 border-amber-600 text-amber-950 dark:bg-yellow-500/20 dark:border-yellow-500/40 dark:text-yellow-300"
                        : "bg-red-50 border-red-600 text-red-950 dark:bg-red-500/20 dark:border-red-500/40 dark:text-red-300"
                  }`}
                >
    ...
    <div className="flex flex-col gap-3">
      <div className="flex items-center gap-3">
        ...
        {!showFallback ? (
          ...
          <div className="tc-placeholder-avatar flex items-center justify-center rounded-xl border-2 border-[color:var(--surface-border)]" style={{ width: '56px', height: '56px' }}>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 20 20"
              fill="currentColor"
